...
import {VaultSY, ISmartYield, ISmartYieldController} from "../../VaultSY.sol";
...
contract VaultSY_ModifyPositionCollateralizationTest is Test, ERC1155Holder {
    ...
    function test_enter_transfersTokens_to_vault(uint256 tokenId, address owner, uint256 amount) public {
