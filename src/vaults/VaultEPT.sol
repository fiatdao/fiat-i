...
contract VaultEPT is Guarded, IVaultEPT, Initializable {
    ...
    constructor(address codex_, address wrappedPosition_, address trancheFactory_) Guarded() {
    ...
    function fairPrice(uint256, bool net, bool face) external view override returns (uint256) {
