...
contract TestGuard is BaseGuard {
    ...
    constructor(address senatus, address guardian, uint256 delay) BaseGuard(senatus, guardian, delay) {}
    ...
    function inRange(uint256 value, uint256 min, uint256 max) external pure {
...
contract BaseGuardTest is Test {
    ...
    function test_inRange(uint256 value, uint256 min, uint256 max) public {
