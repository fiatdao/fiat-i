...
contract CodexGuard is BaseGuard {
    ...
    constructor(address senatus, address guardian, uint256 delay, address codex_) BaseGuard(senatus, guardian, delay) {
        codex = Codex(codex_);
    }
    ...
    function setDebtFloor(address vault, uint256 debtFloor, address[] calldata collateralAuctions) external isGuardian {
