...
// External references
// Flatten contract for https://github.com/sense-finance/sense-v1/blob/dev/pkg/core/src/tokens/Token.sol
...
/// @author https://github.com/Rari-Capital/solmate/blob/fab107565a51674f3a3b5bfdaacc67f6179b1a9b/src/auth/Trust.sol
...
/// @title Base Token
contract SenseToken is ERC20, Trust {
    constructor(
        string memory _name,
        string memory _symbol,
        uint8 _decimals,
